...
Plans:
- [x] 03-01: Extend Zustand layout engine and Konva Stage to support pixel-based multi-slide carousel data structures and ratio presets.
- [x] 03-02: Implement seamless panorama cross-slide photo rendering, slice guide overlays, and drag-and-drop slide reordering.
